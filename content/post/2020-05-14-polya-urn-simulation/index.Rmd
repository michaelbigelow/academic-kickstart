...
tags:
  ...
  - computing
subtitle: ''
summary: 'We introduce the Pólya Urn model and implement a simulation in Python.'
authors: [admin]
...
## Simulation
We consider the Pólya Urn model, implementing the urn as a Python object.  The code for this can be found on my [GitHub](https://github.com/michaelbigelow/StochasticProcesses) for any interested readers.
