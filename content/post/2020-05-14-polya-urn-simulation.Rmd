...
subtitle: ''
<<<<<<< HEAD
summary: 'We introduce the Polya Urn model and implement a simulation in Python.'
=======
summary: 'We introduce the Polya Urn model and implement a simulation in Python'
>>>>>>> 5f9461b992c584200e032463dfb64614ac9fe5ad
authors: [admin]
...
```
# Polya's Urn
Polya's Urn poses an interesting probabilistic experiment.  Below we introduce the model and implement a simulation in Python to solve an exercise from Gregory Lawler's "Introduction to Stochastic Processes."
...
$$= \frac{X_n}{n+2}=M_n.$$
[(Lawler, Gregory F., 2006. "Introduction to Stochastic Processes.")](https://www.amazon.com/Introduction-Stochastic-Processes-Chapman-Probability/dp/158488651X)

## Simulation
We consider the Polya Urn model, implementing the urn as a Python object.  The code for this can be found on my [GitHub](https://github.com/michaelbigelow/StochasticProcesses) for any interested readers.
...
In future posts we will examine more Polya's Urn problems, as well as more concepts from stochastic processes.
