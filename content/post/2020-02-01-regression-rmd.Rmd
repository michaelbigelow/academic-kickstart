...
tags:
  ...
  - regression
subtitle: ''
summary: 'An implementation of the Forsythe-Hayes algorithm in Python, and an example approximating $f(x)=\sin(2\pi x),x\in[0,1]$.'
authors: [admin]
...
```{python, echo=FALSE}
print('a = \n', np.round(forsythehayes(x_i)[1][1:],4))
print('b = \n', np.round(forsythehayes(x_i)[2],4))
```
